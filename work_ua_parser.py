...
class WorkUaParser:
    ...
    def __init__(self, links_list: list[str], path_to_csv: str) -> None:
        """
    ...
    def get_vacancies_from_page(self, page_url: str) -> list[dict]:
        """
    ...
    def save_to_csv(self) -> None:
        ...
        try:
            with open(self.path_to_csv, "w", newline="", encoding="utf-8") as file:
